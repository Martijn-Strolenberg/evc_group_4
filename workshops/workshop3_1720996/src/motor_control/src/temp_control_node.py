...
class MotorSubscriberNode:
    ...
    def motor_cb(self, data):
        ...
        new_mesg = data.new_mesg # Check if it is a new message or just from the prev
        velocity_cmd = data.velocity_cmd # Speed command
        action = data.move_cmd # Direction command
